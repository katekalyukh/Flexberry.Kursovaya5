...
moduleForAcceptance('[AGAT] Acceptance | i i s kursovaya5 печать фото l');

test('testing i-i-s-kursovaya5-печать-фото-l', function(assert) {
  visit('/i-i-s-kursovaya5-печать-фото-l');
