...
moduleForAcceptance('[AGAT] Acceptance | i i s kursovaya5 фотокиоск l');

test('testing i-i-s-kursovaya5-фотокиоск-l', function(assert) {
  visit('/i-i-s-kursovaya5-фотокиоск-l');
